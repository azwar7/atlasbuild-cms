        ...
        <div className="flex items-center gap-4">
          {loading ? (
            ...
            <div className="flex items-center gap-3" ref={dropdownRef}>
              ...
              <Link
                href={dashboardUrl}
                className="hidden sm:flex items-center gap-2 px-4 py-2 bg-primary/20 border border-primary/40 rounded-full text-primary text-xs font-label hover:bg-primary/30 transition-all backdrop-blur-md font-bold uppercase tracking-wider shadow-[0_0_12px_rgba(125,211,252,0.2)]"
              >
